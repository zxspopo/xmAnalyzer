...
public class PinyinNameTransformTokenFilter extends TokenFilter {
    ...
    private static final Logger logger = Logger.getLogger(PinyinNameTransformTokenFilter.class);
    ...
    public PinyinNameTransformTokenFilter(TokenStream input, boolean isFirstChar, int minTermLenght, boolean
            isOutChinese) {
        super(input);
        ...
        for (char c : chinese.toCharArray()) {
            ...
            if (String.valueOf(c).matches("[\\u4E00-\\u9FA5]+")) {
                currentEntry = addToEntry(c, true, currentEntry);
                    ...
                    || (c >= 'A' && c <= 'Z') || String.valueOf(c).matches("\\d|\\s")) {
