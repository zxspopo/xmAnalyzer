...
import com.yonyou.iuap.search.analyzer.PinyinNGramAnalyzer;
...
public class test {
    ...
    public static String getPinyinString(String value) throws Exception {
    ...
    public static void PringString2(String value) throws Exception {
    ...
    public static void PringString1(String value) throws Exception {
...
/*
 * Location: D:\env\solrcloud-single\solr-8983\tomcat\apache-tomcat-8.0.24\webapps\solr\WEB-INF\lib\
 * pinyinAnalyzer4.3.1.jar Qualified Name: com.shentong.search.analyzers.test.test JD-Core Version:
 * 0.6.2
 */
